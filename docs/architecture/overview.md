...
## Goals
- Export fittings via ESI and store as JSON on disk.
...
3. **Storage**: filesystem-based JSON persistence.
...
- Files stored under `FITS_STORAGE_ROOT` (default `./data`).
- One folder per character ID.
